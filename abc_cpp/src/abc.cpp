...
private:
    ...
    void processImage()
    {
        ...
        removePlane(cloud_, cloud_no_plane);
   ...
   void removePlane(pcl::PointCloud<pcl::PointXYZRGB>::Ptr input_cloud, pcl::PointCloud<pcl::PointXYZRGB>::Ptr output_cloud)
    {
        ...
        {
            RCLCPP_WARN(this->get_logger(), "未找到任何平面.");
        ...
        RCLCPP_INFO(this->get_logger(), "平面去除成功，剩余点云数量: %zu", output_cloud->points.size());
    }
